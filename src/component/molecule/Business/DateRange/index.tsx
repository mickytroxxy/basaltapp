        ...
        <Box style={{flexDirection:'row',justifyContent:'space-between'}}>
            {rangeData.data.map((item,i) => (
                <View key={i} style={{width:'45%'}}>
                    ...
                    <TouchableOpacity onPress={() => handleDateSelect(item)} style={{padding:20,borderWidth:1,borderRadius:15,justifyContent:'center'}}><Text fontFamily={'MTNBrighterSans-Regular'}>{item.value}</Text></TouchableOpacity>
                </View>
            ))}
        </Box>
